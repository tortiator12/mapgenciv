			...
			Dispatcher.UIThread.Invoke(() =>
			{
				...
				switch (buttons)
				{
					case MessageBoxButtons.OK:
						messageBox.messageButton1.Content = ClassicShellText.Ok;
						messageBox.messageButton2.IsVisible = false;
						messageBox.messageButton3.IsVisible = false;
					...
					case MessageBoxButtons.OKCancel:
						messageBox.messageButton1.Content = ClassicShellText.Ok;
						messageBox.messageButton2.Content = ClassicShellText.Cancel;
						messageBox.messageButton3.IsVisible = false;
					...
					case MessageBoxButtons.AbortRetryIgnore:
						messageBox.messageButton1.Content = ClassicShellText.Abort;
						messageBox.messageButton2.Content = ClassicShellText.Retry;
						messageBox.messageButton3.Content = ClassicShellText.Ignore;
					...
					case MessageBoxButtons.YesNoCancel:
						messageBox.messageButton1.Content = ClassicShellText.Yes;
						messageBox.messageButton2.Content = ClassicShellText.No;
						messageBox.messageButton3.Content = ClassicShellText.Cancel;
					...
					case MessageBoxButtons.RetryCancel:
						messageBox.messageButton1.Content = ClassicShellText.Retry;
						messageBox.messageButton2.Content = ClassicShellText.Cancel;
						messageBox.messageButton3.IsVisible = false;
					...
					case MessageBoxButtons.CancelTryContinue:
						messageBox.messageButton1.Content = ClassicShellText.Cancel;
						messageBox.messageButton2.Content = ClassicShellText.TryAgain;
						messageBox.messageButton3.Content = ClassicShellText.Continue;
