...
namespace OpenCivOne
{
	public class GameData
	{
		...
		public OpenCivOne.Runtime.ClassicAiProfile AiProfile =
			OpenCivOne.Runtime.ClassicAiProfile.Classic1991;
		...
		public short NextPlayerHistoryRankingTurn = 80;
		...
		internal void ResetMutableStateForNewGame()
		{
			ushort preservedRandomSeed = this.RandomSeed;
			OpenCivOne.Runtime.ClassicAiProfile preservedAiProfile =
				this.AiProfile;
			GBitmap preservedMap = this.map;

			GameData clean = new();
			this.GameKey = clean.GameKey;
			this.GameName = clean.GameName;
			this.TurnCount = clean.TurnCount;
			this.Year = clean.Year;
			this.DifficultyLevel = clean.DifficultyLevel;
			this.HumanPlayerID = clean.HumanPlayerID;
			this.PlayerFlags = clean.PlayerFlags;
			this.PlayerIdentityFlags = clean.PlayerIdentityFlags;
			this.ActiveCivilizations = clean.ActiveCivilizations;
			this.PeaceTurnCount = clean.PeaceTurnCount;
			this.AIOpponentCount = clean.AIOpponentCount;
			this.NextPlayerHistoryRankingTurn =
				clean.NextPlayerHistoryRankingTurn;
			this.GameSettingFlags = clean.GameSettingFlags;
			this.DebugFlags = clean.DebugFlags;

			this.Players = clean.Players;
			this.nationTypes = clean.nationTypes;
			this.PerContinentSizeAndPerOceanSize =
				clean.PerContinentSizeAndPerOceanSize;
			this.Continents = clean.Continents;
			this.Oceans = clean.Oceans;
			this.ScoreGraphData = clean.ScoreGraphData;
			this.PeaceGraphData = clean.PeaceGraphData;
			this.Cities = clean.Cities;
			this.CityNames = clean.CityNames;
			this.CityPositions = clean.CityPositions;
			this.WonderCityID = clean.WonderCityID;
			this.TechnologyFirstDiscoveredBy =
				clean.TechnologyFirstDiscoveredBy;
			this.MaximumTechnologyCount = clean.MaximumTechnologyCount;
			this.MapVisibility = clean.MapVisibility;
			this.PollutedSquareCount = clean.PollutedSquareCount;
			this.PollutionEffectLevel = clean.PollutionEffectLevel;
			this.GlobalWarmingCount = clean.GlobalWarmingCount;
			this.ReplayDataLength = clean.ReplayDataLength;
			this.ReplayData = clean.ReplayData;
			this.SpaceshipFlags = clean.SpaceshipFlags;
			this.AISpaceshipSuccessRate =
				clean.AISpaceshipSuccessRate;
			this.aSpaceshipCells = clean.aSpaceshipCells;
			this.unitTypes = clean.unitTypes;
			this.improvementTypes = clean.improvementTypes;
			this.technologyAdvanceTypes =
				clean.technologyAdvanceTypes;
			this.terrainModifications = clean.terrainModifications;
			this.terrainTypes = clean.terrainTypes;
			this.wonderTypes = clean.wonderTypes;

			this.map = preservedMap;
			this.RandomSeed = preservedRandomSeed;
			this.AiProfile = preservedAiProfile;
		}
