...
namespace OpenCivOne
{
	public class MainIntro
	{
		...
		public void F2_0000_0000_ShowMainGameIntro()
		{
			...
			this.parent.Tools.F0_2dc4_0042_Randomize();
			...
			using (StreamReader reader = new(
				this.parent.RuntimeOptions.GetResourceFilePath("CREDITS.TXT")))
			{
			...
			this.parent.Tools.F0_2dc4_0523_FreeResource(logoBitmapID, "ShowMainIntro");
		}

		/// <summary>
		/// Restores the normal logo backdrop before returning to the main menu
		/// after retirement, without replaying the complete opening sequence.
		/// </summary>
		internal void F2_0000_0001_ShowMainGameLogo()
		{
			this.parent.Var_aa_Screen0_Rectangle.FontID = 1;
			this.parent.ImageTools
				.F0_2fa1_01a2_LoadBitmapOrPalette(
					1,
					0,
					0,
					"LOGO.PIC",
					out byte[] logoPalette);
			int logoBitmapID =
				this.parent.Graphics
					.F0_VGA_0b85_ScreenToBitmap(
						1,
						0,
						64,
						320,
						80);
			this.parent.Graphics
				.F0_VGA_0162_SetColorsFromColorStruct(
					logoPalette);
			this.parent.Tools
				.F0_2dc4_065f_StopPaletteCycleSlots();
			this.parent.DrawTools.FillRectangle(
				...
				0);
			this.parent.Graphics
				.F0_VGA_0c3e_DrawBitmapToScreen(
					this.parent.Var_19d4_Screen1_Rectangle,
					0,
					64,
					logoBitmapID);
			this.parent.Graphics
				.F0_VGA_06b7_DrawScreenToMainScreen(1);
			this.parent.Graphics.F0_VGA_07d8_DrawImage(
				...
				0);
			this.parent.CommonTools.F0_1000_0846(0);
			this.parent.Tools.F0_2dc4_0523_FreeResource(
				logoBitmapID,
				"ReturnToMainMenu");
		}
		...
		public void F2_0000_0bd7_EndGame_SpaceVictory(int playerID)
		{
			...
			for (int i = 0; i < 24; i++)
			{
				this.parent.Tools.F0_2dc4_0523_FreeResource(bitmaps[i], "EndGame_SpaceVictory");
			}
