...
namespace OpenCivOne
{
	public class Overlay_22
	{
		...
		public Overlay_22(OpenCivOneGame parent)
		{
			this.oParent = parent;
		...
		public void F22_0000_0000_DiplomatActionOnACity(int cityID, int playerID, int unitID)
		{
			...
			this.oParent.GameData.Players[playerID].Units[unitID].GoToDestination = OpenCivOneGame.InvalidPosition;
			...
			this.oParent.CAPI.strcat(
				...
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatArrivesInConnector]);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatCityActionMenu]);
			...
			if (this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].HasFlag(DiplomacyFlagsEnum.Unknown40))
				goto L0090;
		...
		L014c:
			...
			this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))] |= DiplomacyFlagsEnum.Unknown40;
		...
		L0194:
			...
			this.oParent.Segment_29f3.F0_29f3_0c9e_ConfirmAttackAction(this.oParent.GameData.Cities[cityID].PlayerID);
		...
		L01b0:
			...
			this.oParent.Segment_2517.F0_2517_0aa1_ClearDiplomacyFlags(this.oParent.GameData.HumanPlayerID, this.oParent.GameData.Cities[cityID].PlayerID, DiplomacyFlagsEnum.Peace);
		...
		L0209:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)),
				(TechnologyAdvanceEnum)((short)this.oCPU.DX.UInt16)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			...
			this.oParent.Segment_1ade.F0_1ade_1d2e(playerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)),
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatStealsConnector]);
		...
		L0341:
			...
			this.oParent.CAPI.strcpy(0xba06,
				ClassicDisplayNames.ImprovementOrWonder(
					this.oCPU.ReadInt16(
						this.oCPU.SS.UInt16,
						(ushort)(this.oCPU.BP.UInt16 - 0x22)) + 1,
					this.oParent.GameData.GetImprovementType(
						this.oCPU.ReadInt16(
							this.oCPU.SS.UInt16,
							(ushort)(this.oCPU.BP.UInt16 - 0x22)) + 1).Name));

			// Instruction address 0x0000:0x0380, size: 5
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatDestroyedSuffix]);
			goto L03a3;
			...
			this.oParent.CAPI.strcpy(
				...
				ClassicDisplayNames.Unit(
					(UnitTypeEnum)this.oParent.GameData.Cities[
						cityID].CurrentProductionID,
					this.oParent.GameData.Units[
						this.oParent.GameData.Cities[
							cityID].CurrentProductionID].Name));
		...
		L03e0:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatProductionSabotagedSuffix]);
		...
		L03fd:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatCityResultInPrefix]);
		...
		L04a4:
			...
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatDissidentsInPrefix]);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatRevoltPriceSuffix]);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatInciteMenu]);
			...
			if (this.oParent.GameData.Players[playerID].Diplomacy[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].HasFlag(DiplomacyFlagsEnum.Peace))
			{
				// Instruction address 0x0000:0x0543, size: 5
				this.oParent.CAPI.strcat(
					0xba06,
					ClassicGameText.Current[
						ClassicGameTextKey.DiplomatSubvertCityOption]);
			}
		...
		L0570:
			...
			if (this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Diplomacy[playerID].HasFlag(DiplomacyFlagsEnum.Peace))
			{
				// Instruction address 0x0000:0x0593, size: 5
				this.oParent.Segment_2517.F0_2517_0aa1_ClearDiplomacyFlags(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26)), playerID, DiplomacyFlagsEnum.Peace);

				this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x26))].Diplomacy[playerID] |= DiplomacyFlagsEnum.Vendetta;
			}
		...
		public void F22_0000_0639_DiplomatInteractionWithUnit(int playerID, int unitID, int playerID1)
		{
			...
			this.oCPU.AX.Int16 = (short)this.oParent.UnitManagement.F0_1866_1251_GetStackUnitValueSum(playerID, unitID, UnitStackValueTypeEnum.UnitCount);
		...
		L065b:
			// A bribed unit is transferred into a new slot while the diplomat
			// survives. Refuse the action when that transfer cannot be
			// represented; otherwise the original flow deletes the target and
			// charges the treasury before CreateUnit reports a full roster.
			if (!this.oParent.UnitManagement.HasFreeActiveUnitSlot(playerID1))
				goto L0961;
			...
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0xc;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)unitID));
			this.oCPU.SI.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.SI.UInt16, this.oCPU.AX.UInt16);
			...
			this.oCPU.CX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.CX.UInt16);
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)this.oParent.GameData.Units[(int)this.oParent.GameData.Players[playerID].Units[unitID].UnitType].Cost));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);

			if (this.oParent.GameData.Players[playerID].Units[unitID].UnitType != UnitTypeEnum.Settler)
			{
				this.oCPU.CX.UInt16 = 0x2;
				this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
				this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
		...
		L06d6:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Units[(int)this.oParent.GameData.Players[playerID].Units[unitID].UnitType].Name);

			// Instruction address 0x0000:0x0729, size: 5
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatWillDesertForConnector]);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatTreasuryPrefix]);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatPayMenu]);
		...
		L07d4:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.DiplomatUnitBribedByConnector]);
		...
		L0898:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[playerID].Units[unitID].UnitType);
			...
			this.oCPU.AX.Int16 = (short)this.oParent.UnitManagement.F0_1866_0cf5_CreateUnit(playerID1, 
				(UnitTypeEnum)this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
			...
			this.oCPU.AX.UInt16 = 0x38;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)playerID1));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
		...
		public void F22_0000_0967(int xPos, int yPos)
		{
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(1, 0, 0, "NUKE1.PIC", 1);
		...
		L099f:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(xPos, 80, 276);

			xPos = this.oCPU.AX.Int16;

			// Instruction address 0x0000:0x0a32, size: 5
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(yPos, 8, 0x9c);

			yPos = this.oCPU.AX.Int16;

			// Instruction address 0x0000:0x0a41, size: 5
			this.oParent.CommonTools.PlayTune(42, 0);

			// Instruction address 0x0000:0x0a62, size: 5
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_aa_Screen0_Rectangle, xPos, yPos, 44, 44, this.oParent.Var_19d4_Screen1_Rectangle, xPos, yPos);
		...
		L0a77:
			...
			this.oParent.CommonTools.WaitTimer(5);

			// Instruction address 0x0000:0x0ab3, size: 5
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Screen1_Rectangle, xPos, yPos, 44, 44, this.oParent.Var_aa_Screen0_Rectangle, xPos, yPos);
		...
		L0acf:
			...
			this.oParent.Tools.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x38)), "");
		...
		/// <param name="cityID"></param>
		/// <param name="playerID"></param>
		public void F22_0000_0af5(int cityID, int playerID)
		{
			...
			this.oCPU.PUSH_UInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)((short)cityID));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
		...
		L0c18:
			...
			this.oCPU.BX.UInt16 = (ushort)((short)playerID);
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
		...
		L0c77:
			...
			this.oCPU.CX.LowInt8 = (sbyte)this.oParent.GameData.HumanPlayerID;
		...
		L0d52:
			...
			if (this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16))].UnitType == UnitTypeEnum.None)
				goto L0e45;
		...
		L0db0:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16))].UnitType);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
			
			// Instruction address 0x0000:0x0dce, size: 5
			this.oParent.UnitManagement.F0_1866_0f10_DeleteUnit(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)),
			...
			this.oCPU.AX.Int16 = (short)this.oParent.UnitManagement.F0_1866_0cf5_CreateUnit(playerID,
			...
			this.oParent.GameData.Players[playerID].Units[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].HomeCityID = (short)cityID;
		...
		L0e52:
			...
			this.oParent.Var_28bc = true;

			if (this.oParent.Var_deba > 1) goto L0e6a;
		...
		L0e6a:
			...
			this.oParent.Segment_2459.F0_2459_0000_CityTakeover(playerID, cityID, true);

			this.oParent.Var_28bc = false;
		...
		public void F22_0000_0eaf(short cityID)
		{
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(1, 0, 0, "SETTLERS.PIC", 0);
		...
		L0ef1:
			...
			this.oParent.CAPI.strcat(0xba06, this.oParent.Segment_1238.GetYearAsString(this.oParent.GameData.Year));
			...
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 4, 0);

			this.oParent.Var_aa_Screen0_Rectangle.FontID = 1;

			// Instruction address 0x0000:0x0ff5, size: 5
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Screen1_Rectangle, 0, 120, 320, 40, this.oParent.Var_19d4_Screen1_Rectangle, 0, 0);
		...
		L101a:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Screen1_Rectangle, 0, 0, 320, 40, this.oParent.Var_19d4_Screen1_Rectangle, 0, 120);
		...
		L1047:
			...
			this.oParent.Graphics.F0_VGA_07d8_DrawImage(this.oParent.Var_19d4_Screen1_Rectangle, 0, 120, 320, 40, this.oParent.Var_aa_Screen0_Rectangle, 0, 120);
		...
		L10aa:
			...
			if (this.oParent.CAPI.kbhit() != 0) goto L10cc;
			
			if (mouseEvent.Buttons != MouseButtonsEnum.None) goto L10cc;
			goto L100e;

		L10cc:
			// Instruction address 0x0000:0x10d3, size: 5
			this.oParent.Tools.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)), "Set");

			// Instruction address 0x0000:0x10fc, size: 5
			this.oParent.CommonTools.TransformPaletteToColor(10, Color.FromRgb(0, 0, 0));
