...
namespace OpenCivOne
{
	public class TextBoxDialogs
	{
		...
		public TextBoxDialogs(OpenCivOneGame parent)
		{
			this.parent = parent;
		}
		...
		public int F23_0000_0000_CityNameDialog(int cityID)
		{
			...
			{
				string oldName = this.parent.GameData.CityNames[this.parent.GameData.Cities[cityID].NameID].TrimEnd(' ', '\x0');
				string? newName = this.parent.Host.ShowTextInput(
					ClassicShellText.CityNameTitle,
					ClassicShellText.CityNamePlaceholder,
					oldName,
					12,
					false);
				...
				{
					this.parent.GameData.CityNames[this.parent.GameData.Cities[cityID].NameID] = newName;
				}

				return string.IsNullOrEmpty(newName) ? 0 : 1;
			}
			...
			while (nameLength == 0)
			{
				...
				this.parent.DrawTools.DrawRectangle(80, 80, 160, 32, 11);
		...
		public void F23_0000_00d6_PlayerNameDialog()
		{
			...
			// function body
			string? playerName = this.parent.Host.ShowTextInput(
				ClassicShellText.PlayerNameTitle,
				ClassicShellText.PlayerNamePlaceholder,
			...
			this.parent.DrawTools.DrawRectangle(158, 88, 160, 32, 11);
		...
		public void F23_0000_0173_TribeNameDialog()
		{
			...
			string? nationality = this.parent.Host.ShowTextInput(
				ClassicShellText.NationNameTitle,
				ClassicShellText.NationNamePlaceholder,
		...
		public void F23_0000_025b_FindCityDialog()
		{
			...
			string? cityName = this.parent.Host.ShowTextInput(
				ClassicShellText.FindCityTitle,
				ClassicShellText.FindCityPlaceholder,
				null,
				12,
				true);
			...
			this.parent.DrawTools.DrawRectangle(64, 78, 224, 24, 0);
			...
			if (!string.IsNullOrEmpty(cityName))
			{
				...
				this.parent.Host.ShowInformation(
					ClassicShellText.CityNotFound(cityName),
					ClassicShellText.UnknownCityTitle);
			}
		...
		/*public int F23_0000_0414_EditBoxDialog(int xPos, int yPos, int maxTextLength)
		{
			...
			this.parent.DrawTools.DrawRectangle(xPos, yPos - 1, maxTextLength * 8 + 8, 13, 0);
		...
		L0520:
			...
			this.parent.CommonTools.UpdateMouseState();
