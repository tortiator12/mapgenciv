...
namespace OpenCivOne
{
	public class StartGame
	{
		...
		public StartGame(OpenCivOneGame parent)
		{
			this.parent = parent;
		}
		...
		/// Main game entry
		/// </summary>
		public void F0_11a8_0008_StartGame()
		{
			...
			do
			{
				...
				returnToMainMenu =
					ClassicGameStartPolicy.ShouldReturnToMainMenu(
						this.parent.Var_dc48_GameEndType);
				if (returnToMainMenu)
				{
					PrepareForMainMenuAfterGameEnd();
					this.parent.MainIntro
						.F2_0000_0001_ShowMainGameLogo();
				}
			}
			...
			this.parent.Tools.F0_2dc4_0523_FreeResource(this.parent.Var_6e92_MouseIconHandle, "Mouse icon");
		}

		internal void PrepareForMainMenuAfterGameEnd()
		{
			this.parent.CommonTools.PlayTune(0, 0);
			this.parent.CommonTools.ClearKeyboardAndMouseEvents();
			this.parent.UnitAutomationState.Clear();
			this.parent.Var_6b32_SelectedGameType =
				(int)ClassicGameStartMode.None;
			this.parent.Var_dc48_GameEndType = 0;
			this.parent.Var_b884 = 0;
			this.parent.Var_df60 = 0;
		}
		...
		public void F0_11a8_0486_LogoAndMainGameMenu()
		{
			...
			while (this.parent.Var_6b32_SelectedGameType == -1)
			{
				...
				this.parent.Var_6b32_SelectedGameType = this.parent.MenuBoxDialog.F0_2d05_0031_ShowMenuBox(
				...
				switch (this.parent.Var_6b32_SelectedGameType)
				{
					case 0:
						...
						this.parent.StartGameMenu
							.ResetProject1991StateForNewGame();
			...
			if (ClassicGameStartPolicy.RequiresNewGameInitialization(
				this.parent.Var_6b32_SelectedGameType))
			{
			...
			this.parent.Tools.F0_2dc4_05dd_AddPaletteCycleSlots();
		}
		...
		public void F0_11a8_087c_NewGameMenu()
		{
			...
			ClassicGameStartPolicy.InitializeNewGameDataIfRequired(
				this.parent.Var_6b32_SelectedGameType,
				() =>
				{
