...
namespace OpenCivOne
{
	public class Overlay_18
	{
		...
		public Overlay_18(OpenCivOneGame parent)
		{
			this.oParent = parent;
		...
		public void F18_0000_0000()
		{
			...
			this.oParent.ImageTools.F0_2fa1_01a2_LoadBitmapOrPalette(1, 0, 0, "DOCKER.PIC", 1);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x0);

		L0055:
			this.oCPU.AX.UInt16 = 0x1a;
			...
			this.oParent.Graphics.F0_VGA_0b85_ScreenToBitmap(1,
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4be2)),
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4be4)),
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4be6)),
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.SI.UInt16 + 0x4be8)));
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x682a), this.oCPU.AX.UInt16);
		...
		L0095:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CAPI.RNG.Next(240));

			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.AX.LowUInt8);

			// Instruction address 0x0000:0x00ac, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CAPI.RNG.Next(192));

			this.oCPU.AX.LowUInt8 = this.oCPU.ADD_UInt8(this.oCPU.AX.LowUInt8, 0x8);
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6852), this.oCPU.AX.LowUInt8);
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6866), 0x0);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2))));
			...
			this.oParent.CommonTools.AddPaletteCycleSlot(1, 30, 208, 223);

			// Instruction address 0x0000:0x00f8, size: 5
			this.oParent.CommonTools.AddPaletteCycleSlot(2, 11, 192, 207);

			// Instruction address 0x0000:0x0110, size: 5
			this.oParent.CommonTools.AddPaletteCycleSlot(3, 20, 224, 239);

			// Instruction address 0x0000:0x0128, size: 5
			this.oParent.CommonTools.AddPaletteCycleSlot(4, 8, 144, 159);

			// Instruction address 0x0000:0x0140, size: 5
			this.oParent.CommonTools.AddPaletteCycleSlot(5, 150, 128, 129);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x1);

		L0154:
			// Instruction address 0x0000:0x0157, size: 5
			this.oParent.CommonTools.StartPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x5);
		...
		public void F18_0000_016d()
		{
			...
			this.oParent.Tools.F0_2dc4_0523_FreeResource(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x682a), "Dock");

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 0x1);

		L018f:
			// Instruction address 0x0000:0x0192, size: 5
			this.oParent.CommonTools.StopPaletteCycleSlot(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)));
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0x5);
			...
			this.oParent.Tools.F0_2dc4_05dd_AddPaletteCycleSlots();
		...
		public ushort F18_0000_0259(short playerID, short param2, short param3)
		{
			...
			this.oCPU.PUSH_UInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.SP.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.SP.UInt16, 0x20);
			this.oCPU.PUSH_UInt16(this.oCPU.DI.UInt16);
			this.oCPU.PUSH_UInt16(this.oCPU.SI.UInt16);

			if (playerID == this.oParent.GameData.HumanPlayerID) goto L0275;

			if (!this.oParent.GameData.GameSettingFlags.EnemyMoves) goto L027a;
		...
		L0286:
			...
			this.oParent.DrawTools.FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 0, 0, 320, 8,
				this.oParent.Array_1946_PlayerColours[playerID]);
			...
			this.oParent.CAPI.strcat(
				...
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipTitleConnector]);
			...
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xb9ff),
				(byte)this.oParent.GameData.Players[playerID].Nationality[0]);

			// Instruction address 0x0000:0x031d, size: 5
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 1, 0);
		...
		L032a:
			...
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2), 0x0);
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 10);
		...
		L0343:
			...
			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa), 
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos);

			this.oCPU.WriteInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10),
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].YPos);

			this.oCPU.AX.UInt16 = 0xb4;
			...
			this.oCPU.BX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.BX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));

			int iPos = (12 * this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos) +
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].YPos;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8),
				(ushort)((short)this.oParent.GameData.Players[playerID].SpaceshipData[iPos]));

			if (this.oParent.GameData.Players[playerID].SpaceshipData[iPos] == -1)
				goto L04b0;
			...
			this.oParent.Graphics.F0_VGA_0c3e_DrawBitmapToScreen(this.oParent.Var_aa_Screen0_Rectangle,
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) * 16) - 16,
				(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) * 16) + 8,
				this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.AX.UInt16 << 1 + 0x682a)));
		...
		L03f9:
			...
			this.oCPU.SI.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.SI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)));
			this.oCPU.DI.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
			this.oCPU.DI.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.DI.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1c)));
			
			F18_0000_0c11_GetSpaceShipData(playerID, (short)((ushort)(this.oCPU.SI.UInt16 + 0x1)), (short)this.oCPU.DI.UInt16);
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), this.oCPU.AX.UInt16));
			...
			F18_0000_0c11_GetSpaceShipData(playerID, (short)this.oCPU.SI.UInt16, (short)((ushort)(this.oCPU.DI.UInt16 + 0x1)));
		...
		L0469:
			...
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2))));
			goto L04c9;
		...
		L047a:
			...
			this.oParent.DrawTools.DrawRectangle(
				(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xa)) << 4) - 16,
				(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)) << 4) + 8,
				(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1a)) << 4) - 1,
				(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x1e)) << 4) - 1,
				12);

			goto L04c9;

		L04b0:
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].BitmapID < 3)
			{
		...
		L04c9:
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].XPos != -1)
				goto L0343;
		...
		L04ef:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x4be0));
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe));
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xdea2)));
			...
			this.oParent.Graphics.F0_VGA_0c3e_DrawBitmapToScreen(this.oParent.Var_aa_Screen0_Rectangle, 152, 88, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x6834));
		...
		L0534:
			...
			this.oParent.DrawTools.FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 240, 8, 80, 192, this.oParent.Array_1946_PlayerColours[playerID]);

			// Instruction address 0x0000:0x0571, size: 5
			this.oParent.Graphics.F0_VGA_0599_DrawLine(this.oParent.Var_aa_Screen0_Rectangle, 0, 8, 0, 199, this.oParent.Array_1946_PlayerColours[playerID]);

			// Instruction address 0x0000:0x058a, size: 5
			this.oParent.Graphics.F0_VGA_0599_DrawLine(this.oParent.Var_aa_Screen0_Rectangle, 0, 199, 240, 199, this.oParent.Array_1946_PlayerColours[playerID]);

		L0592:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0x64);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 0x10);

			// Instruction address 0x0000:0x05ab, size: 5
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0("Population:", 242, 16, 0);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x8));
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeae), 10));
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(0xba06, 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);

		L0609:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x8));

			// Instruction address 0x0000:0x0619, size: 5
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdeae), 1, 99);

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0x64;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeb0));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);

			// Instruction address 0x0000:0x0638, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Support: ");

			// Instruction address 0x0000:0x0658, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 10));

			// Instruction address 0x0000:0x0668, size: 5
			this.oParent.CAPI.strcat(0xba06, "%");

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x64);
		...
		L067d:
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(0xba06, 
				242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 
		...
		L06b9:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdeae) + this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdeb0), 
				1, 99);

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0xc8;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeb2));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);

			// Instruction address 0x0000:0x06e8, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Energy: ");
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), this.oCPU.CX.UInt16);
		...
		L0764:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), 0x0);
			if (this.oCPU.Flags.E) goto L0784;
			
			// Instruction address 0x0000:0x077c, size: 5
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0("Mass:", 242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0);
		...
		L0784:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)) / 10), 10));
			...
			this.oParent.CAPI.strcat(0xba06, "00 tons");
		...
		L0817:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdea8), 1, 99);

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.AX.UInt16 = 0x64;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeaa));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);
			...
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipFuelPrefix]);
		...
		L0891:
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(0xba06, 
				242, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), this.oCPU.AX.LowUInt8);
		...
		L08a5:
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipFlightTime],
				242,
				this.oCPU.ReadInt16(
					this.oCPU.SS.UInt16,
					(ushort)(this.oCPU.BP.UInt16 - 0x10)),
				0);
		...
		L08c5:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(
				10 * this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdea8), 
				0, 10 * this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xdeaa));

			this.oCPU.CX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CX.UInt16 = this.oCPU.INC_UInt16(this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = 0x32;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6)));
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0x96);
			if (this.oCPU.Flags.LE) goto L0904;
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, 0x96);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 
				this.oCPU.SUB_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oCPU.AX.UInt16));
		...
		L0904:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)) / 10), 10));
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipYearsSuffix]);
		...
		L0993:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));

			// Instruction address 0x0000:0x09a1, size: 5
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0, 100);
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipSuccessProbability],
				242,
				this.oCPU.ReadInt16(
					this.oCPU.SS.UInt16,
					(ushort)(this.oCPU.BP.UInt16 - 0x10)),
		...
		L09c8:
			...
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 10));
		...
		L0a28:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x10));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeae), 0x0);
		...
		L0a4f:
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(
				this.oParent.GameData.Players[playerID].SpaceshipETAYear <
					oParent.GameData.Year
					? ClassicGameText.Current[
						ClassicGameTextKey.SpaceshipLanded]
					: ClassicGameText.Current[
						ClassicGameTextKey.SpaceshipLaunched],
				242,
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)),
				0);
		...
		L0a7e:
			...
			this.oCPU.CX.UInt16 = 0xa;
			this.oCPU.IDIV_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, (ushort)this.oParent.GameData.Year);
			this.oParent.GameData.Players[playerID].SpaceshipETAYear = (short)this.oCPU.AX.UInt16;
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipLaunchButton],
				256,
				190,
				0);

			// Instruction address 0x0000:0x0ad2, size: 5
			this.oParent.DrawTools.DrawRectangle(242, 188, 76, 9, 0);
		...
		L0b17:
			...
			this.oParent.CommonTools.WaitTimer((short)this.oCPU.AX.UInt16);
			...
			if (this.oParent.CAPI.kbhit() != 0) goto L0b3a;

			param2--;
			if (param2 == 0) goto L0b3a;

			if (mouseEvent.Buttons == MouseButtonsEnum.None) goto L0af3;

		L0b3a:
			if (param2 == 0) goto L0b4f;

			if (mouseEvent.Buttons != MouseButtonsEnum.None) goto L0b4f;
		...
		L0b6c:
			if (mouseEvent.Buttons == MouseButtonsEnum.None) goto L0b83;

			if (mouseEvent.Position.X <= 242) goto L0b83;

			if (mouseEvent.Position.Y >= 190) goto L0b89;
		...
		L0b89:
			...
			this.oParent.CAPI.strcpy(
				...
				ClassicGameText.Current.Format(
					ClassicGameTextKey.SpaceshipConfirmLaunch,
					this.oCPU.ReadInt16(
						this.oCPU.SS.UInt16,
			...
			F18_0000_15c3(this.oParent.GameData.HumanPlayerID);

		L0bfc:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xdeae);
			this.oParent.GameData.Players[playerID].SpaceshipPopulation = (short)this.oCPU.AX.UInt16;
		...
		public ushort F18_0000_0c11_GetSpaceShipData(short playerID, int xPos, int yPos)
		{
			...
			// function body
			sbyte[] spaceshipData = this.oParent.GameData.Players[playerID].SpaceshipData;

			// Ship parts may touch the outer edge of the 15 x 12 grid. The
			// Classic adjacency calculation probes one cell beyond that edge;
			// outside cells are empty, not valid array positions.
			if (xPos < 0 || xPos >= spaceshipData.Length / 12 ||
				yPos < 0 || yPos >= 12)
			{
				this.oCPU.AX.UInt16 = 0;
			...
			sbyte sdata = spaceshipData[(12 * xPos) + yPos];
		...
		L0c57:
			...
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.ADD_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)), 0x2));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x7);

		L0c64:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)), 0xf0);
			if (this.oCPU.Flags.B) goto L0c8d;
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), 0x1);
		...
		L0c8d:
			...
			this.oParent.Graphics.F0_VGA_038c_GetPixel(0, 
				this.oCPU.ReadInt8(this.oCPU.DS.UInt16, (ushort)(0x683e + this.oCPU.BX.UInt16)),
				this.oCPU.ReadInt8(this.oCPU.DS.UInt16, (ushort)(0x6852 + this.oCPU.BX.UInt16)));

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), this.oCPU.AX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE) goto L0cf4;
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6866), 0x1);

			// Instruction address 0x0000:0x0cc6, size: 5
			this.oParent.Graphics.F0_VGA_0550_SetPixel(this.oParent.Var_aa_Screen0_Rectangle.ScreenID, 
				this.oCPU.ReadInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e)),
				this.oCPU.ReadInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6852)),
		...
		L0cd0:
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.INC_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e))));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x3);
			goto L0c64;

		L0cde:
			this.oCPU.TEST_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, 0x687a), 0x1);
			if (this.oCPU.Flags.E) goto L0cec;
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e), this.oCPU.INC_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x683e))));

		L0cec:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x8);
			goto L0c64;
		...
		L0cff:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4)), 0x14);
			if (this.oCPU.Flags.GE) goto L0d47;
			this.oCPU.BX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4));
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x6866)), 0x0);
		...
		L0d47:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0x687a, this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x687a)));
			this.oCPU.SP.UInt16 = this.oCPU.BP.UInt16;
			this.oCPU.BP.UInt16 = this.oCPU.POP_UInt16();
			// Far return
		...
		public ushort F18_0000_0d4f(short playerID, short param2)
		{
			...
			this.oCPU.PUSH_UInt16(this.oCPU.SI.UInt16);
			this.oCPU.AX.UInt16 = 0;
			this.oParent.GameData.AISpaceshipSuccessRate = (short)this.oCPU.AX.UInt16;
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x3e7);
			this.oCPU.CMP_UInt16((ushort)param2, 0x2);
			if (this.oCPU.Flags.E) goto L0d9b;
			this.oCPU.SI.UInt16 = (ushort)this.oParent.GameData.Players[playerID].SpaceshipETAYear;
			this.oCPU.CMP_UInt16(this.oCPU.SI.UInt16, 0xffff);
			if (this.oCPU.Flags.E) goto L0da0;
			this.oCPU.AX.UInt16 = this.oCPU.SI.UInt16;
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, (ushort)this.oParent.GameData.Year);
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, 0xf);
			if (this.oCPU.Flags.GE) goto L0da0;
			this.oCPU.DI.UInt16 = (ushort)this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].SpaceshipETAYear;
			this.oCPU.CMP_UInt16(this.oCPU.SI.UInt16, this.oCPU.DI.UInt16);
			if (this.oCPU.Flags.L) goto L0d9b;
			this.oCPU.CMP_UInt16(this.oCPU.DI.UInt16, 0xffff);
			if (this.oCPU.Flags.NE) goto L0da0;

		L0d9b:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), 0x21);
		...
		L0da0:
			...
			int iPos = (12 * this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].XPos) +
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID >= (short)this.oCPU.CX.UInt16)
			{
		...
		L0df7:
			...
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID);
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.IDIV_UInt8(this.oCPU.AX, this.oCPU.CX.LowUInt8);
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, (ushort)param2);
		...
		L0e1a:
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].XPos == -1)
				goto L0e68;

			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
		...
		L0e4a:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0xe68))) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0e68;
		...
		L0eb6:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipBuildsSuffix]);

			// Instruction address 0x0000:0x0f06, size: 5
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 96, 15);
			...
			this.oParent.GameData.Players[playerID].SpaceshipData[iPos] =
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6))].BitmapID;
		...
		L0fc0:
			...
			this.oParent.Var_b276_MenuBoxDisabledOptions = this.oCPU.AX.Int16;
		...
		L1044:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), 0x63);
		...
		L1055:
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID >= 3)
				goto L1075;

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), 0x63);
		...
		L1078:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x21);
			...
			int iPos = (12 * this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos) +
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].YPos;
		...
		L10c3:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2), 0x63);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0xffff);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0x21);
		...
		L10d2:
			...
			iPos = (12 * this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos) +
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].YPos;
		...
		L1137:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CMP_UInt8(this.oCPU.ReadUInt8(this.oCPU.ES.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x0)), 0xff);
			...
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)));
			this.oCPU.CX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6));
			this.oCPU.CX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.CX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));
		...
		L116e:
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID == this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)))
				goto L11cf;
		...
		L11b6:
			...
			if (this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].XPos != -1)
				goto L116e;
		...
		L11cf:
			...
			this.oParent.GameData.Players[playerID].SpaceshipData[iPos] =
				this.oParent.GameData.SpaceshipCells[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].BitmapID;
		...
		L120c:
			...
			this.oCPU.BX.UInt16 = param2;
			this.oCPU.BX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.BX.UInt16, 0x1);
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16));
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x687a), this.oCPU.OR_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, (ushort)(this.oCPU.BX.UInt16 + 0x687a)), this.oCPU.AX.UInt16));

			// Instruction address 0x0000:0x122b, size: 5
			this.oParent.CAPI.strcpy(0xba06, "No further ");

			this.oCPU.AX.UInt16 = 0x3;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, param2);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)));
			this.oCPU.CX.UInt16 = 0x1a;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.CX.UInt16);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x4bd0);
			// Instruction address 0x0000:0x1249, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oCPU.AX.UInt16);

			// Instruction address 0x0000:0x1259, size: 5
			this.oParent.CAPI.strcat(0xba06, " required.\n");
		...
		L128e:
			...
			if (this.oCPU.Flags.NE)
			{
				this.oParent.GameData.Players[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].ContactPlayerCountdown = 0;
			}
		...
		L12c2:
			...
			this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].SpaceshipSuccessRate = (short)this.oCPU.AX.UInt16;
		...
		public void F18_0000_1527_ShowSpaceshipNationDialog()
		{
			...
			this.oCPU.TEST_UInt16((ushort)this.oParent.GameData.SpaceshipFlags, 0xfe00);
			if (this.oCPU.Flags.NE) goto L1538;
			goto L15bf;

		L1538:
			// Instruction address 0x0000:0x1540, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Which nation?\n ");

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), 0x1);

		L154d:
			// Instruction address 0x0000:0x155a, size: 5
			this.oParent.CAPI.strcat(0xba06, this.oParent.GameData.Players[this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4))].Nationality);
			...
			F18_0000_0259(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x2)), -1, 1);
		...
		public void F18_0000_15c3(short playerID)
		{
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipLaunchesSuffix]);

			// Instruction address 0x0000:0x162d, size: 5
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 92, 15);

			// Instruction address 0x0000:0x163d, size: 5
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.SpaceshipArrivalPrefix]);

			// Instruction address 0x0000:0x165e, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[playerID].SpaceshipETAYear, 10));

			// Instruction address 0x0000:0x166e, size: 5
			this.oParent.CAPI.strcat(0xba06, ".\n");

			// Instruction address 0x0000:0x1686, size: 5
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(0xba06, 160, 100, 15);

			this.oParent.GameData.Players[playerID].SpaceshipLaunchYear = oParent.GameData.Year;
		...
		L16a1:
			...
			if (playerID == this.oParent.GameData.HumanPlayerID) goto L16ce;
