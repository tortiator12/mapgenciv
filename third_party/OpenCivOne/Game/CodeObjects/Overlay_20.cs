...
namespace OpenCivOne
{
	public class Overlay_20
	{
		...
		public Overlay_20(OpenCivOneGame parent)
		{
			this.oParent = parent;
		...
		public ushort F20_0000_0000(int playerID, int x, int y, int citySize)
		{
			...
			this.oParent.AIEngine.F0_25fb_3401_PlayerClearContinentPolicies(playerID, UnitRoleTypeEnum.Settler, x, y, 4);
		...
		L0033:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.Players[playerID].NationalityID;
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.DEC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))));

		L0057:
			this.oCPU.CX.LowUInt8 = 0x4;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), this.oCPU.SHL_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), this.oCPU.CX.LowUInt8));
		...
		L0062:
			...
			if (this.oParent.GameData.CityPositions[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].X == -1)
				goto L00ab;
			...
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x10);
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));
			if (this.oCPU.Flags.NE) goto L008e;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 0xe0);

		L008e:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x100);
		...
		L00fe:
			byte cityNameID = this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
			string cityName = this.oParent.GameData.CityNames[cityNameID];
			this.oParent.GameData.CityNames[cityNameID] = (cityName.Length > 12) ? cityName.Substring(0, 12) : cityName;

		L0118:
			cityNameID = this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].NameID;
			this.oParent.GameData.CityNames[cityNameID] = this.oParent.GameData.CityNames[cityNameID].TrimEnd(' ', '\x0');
			...
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].FoodCount = 0;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ShieldsCount = 0;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ImprovementFlags = 0;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 1;
			...
			{
				this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 4;
			}

			// Instruction address 0x0000:0x0235, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(playerID, TechnologyAdvanceEnum.Conscription) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
			{
				this.oCPU.AX.UInt16 = 0x1c;
				this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
				this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
				this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = 5;
			}
		
			this.oCPU.AX.UInt16 = 0x1c;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Unknown[0] = -1;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Unknown[1] = -1;
		...
		L026a:
			...
			if (this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))].PlayerID != playerID) goto L0289;
		...
		L0289:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x80);
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].ImprovementFlags = 1;
		...
		L02c6:
			...
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].TradeCityIDs[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc))] = -1;
			...
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].SpecialWorkerFlags = 0;
		...
		L02f2:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.MapManagement.F0_2aea_195d_GetMapGroupSize(x + direction.X, y + direction.Y);
		...
		L033c:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag |= 2;

		L0349:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0xb);
			if (this.oCPU.Flags.E) goto L0355;
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x5);
		...
		L0355:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].StatusFlag |= 8;
		...
		L0362:
			...
			if (playerID != this.oParent.GameData.HumanPlayerID) goto L0385;

			this.oParent.Help.F4_0000_02d3_ShowInstantAdvicePopup("*FIRSTPRODUCT");
		...
		L03bf:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x18);
			...
			this.oCPU.CMP_UInt16(this.oCPU.AX.UInt16, (ushort)this.oParent.GameData.HumanPlayerID);
		...
		L0411:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x2d);
		...
		L0484:
			...
			this.oParent.Segment_1ade.F0_1ade_03ea(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8)));
		...
		L0499:
			...
			this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].CurrentProductionID = (sbyte)this.oCPU.AX.LowUInt8;

			// Instruction address 0x0000:0x04bb, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CityWorker.F0_1d12_6c97_PlayerHasWonder(this.oParent.GameData.HumanPlayerID, WonderEnum.ApolloProgram) ? 1 : 0);
			
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.E) goto L04fd;

			this.oParent.GameData.MapVisibility[this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.X,
				this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8))].Position.Y] |= (ushort)(1 << this.oParent.GameData.HumanPlayerID);
		...
		L0502:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*PMAX"));
		...
		L0552:
			...
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), this.oCPU.OR_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), this.oCPU.AX.UInt16));
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.CAPI.RNG.Next(10));
		...
		L05d1:
			this.oCPU.TEST_UInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x10);
		...
		L05da:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0xfffe);
		...
		L05ed:
			...
			this.oCPU.CX.LowUInt8 = this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			...
			this.oParent.CAPI.strcat(0xba06,
				ClassicDisplayNames.ImprovementOrWonder(
					this.oCPU.ReadInt16(
						this.oCPU.SS.UInt16,
						(ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1,
					this.oParent.GameData.GetImprovementType(
						this.oCPU.ReadInt16(
							this.oCPU.SS.UInt16,
							(ushort)(this.oCPU.BP.UInt16 - 0x10)) + 1).Name));
		...
		L0698:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID, TechnologyAdvanceEnum.Medicine) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
		...
		L06b9:
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0x100);
			if (this.oCPU.Flags.E) goto L06c4;
			goto L0bc6;

		L06c4:
			// Instruction address 0x0000:0x06ce, size: 5
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xcc4)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L06dd;
		...
		L06dd:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D1"));
		...
		L06fa:
			...
			this.oParent.GameData.Cities[cityID].ActualSize -= (sbyte)this.oCPU.AX.LowUInt8;
			goto L0bc6;

		L0703:
			this.oCPU.TEST_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x800);
		...
		L070d:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0x80);
		...
		L071f:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xca6)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0738;
		...
		L0738:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D2"));
		...
		L0750:
			this.oCPU.TEST_UInt8(this.oCPU.ReadUInt8(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x20);
		...
		L0759:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0x8);
		...
		L076b:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc2e)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L0784;
		...
		L0784:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D3"));
		...
		L07b6:
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0x4);
		...
		L07c0:
			...
			this.oCPU.AX.UInt16 = (ushort)(this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID,
				(TechnologyAdvanceEnum)this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0xc10)) ? 1 : 0);
			this.oCPU.AX.UInt16 = this.oCPU.OR_UInt16(this.oCPU.AX.UInt16, this.oCPU.AX.UInt16);
			if (this.oCPU.Flags.NE)
				goto L07d9;
		...
		L07d9:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D4"));

			this.oParent.GameData.Cities[cityID].FoodCount = 0;
			this.oCPU.AX.LowUInt8 = (byte)this.oParent.GameData.Cities[cityID].ActualSize;
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.CX.LowUInt8 = 0x3;
			this.oCPU.IDIV_UInt8(this.oCPU.AX, this.oCPU.CX.LowUInt8);
			...
			// Instruction address 0x0000:0x068d, size: 5
			this.oParent.CAPI.strcat(0xba06, "Citizens demand GRANARY.\n");
		...
		L0835:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D5"));

			goto L0bc6;

		L08b1:
			this.oCPU.TEST_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 0x400);
		...
		L08cd:
			...
			this.oParent.CAPI.strcpy(0xba06, this.oParent.LanguageTools.F0_2f4d_044f_GetTextFromKingSection("*D6"));
		...
		L0924:
			...
			this.oParent.CAPI.strcpy(0xba06, "Rioting in ");
		...
		L0934:
			...
			this.oParent.CAPI.strcat(0xba06, "TEMPLE\n");

			goto L09c3;

		L0963:
			// Instruction address 0x0000:0x092c, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Corruption in ");

			goto L0934;

		L0968:
			// Instruction address 0x0000:0x092c, size: 5
			this.oParent.CAPI.strcpy(0xba06, "Scandal in ");
		...
		L096d:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)cityID);
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.TEST_UInt16(this.oParent.GameData.Cities[cityID].ImprovementFlags0, 0x40);
			if (this.oCPU.Flags.NE) goto L0981;
			
			// Instruction address 0x0000:0x09c8, size: 5
			this.oParent.CAPI.strcat(0xba06, "COURTHOUSE\n");
		...
		L0981:
			...
			// Instruction address 0x0000:0x09c8, size: 5
			this.oParent.CAPI.strcat(0xba06, "MARKETPLACE\n");
		...
		L0995:
			...
			if (this.oParent.Segment_1ade.F0_1ade_22b5_PlayerHasTechnology(this.oParent.GameData.Cities[cityID].PlayerID, TechnologyAdvanceEnum.Religion) &&
				!this.oParent.GameData.Cities[cityID].HasImprovement(ImprovementEnum.Cathedral))
			{
				// Instruction address 0x0000:0x09c8, size: 5
				this.oParent.CAPI.strcat(0xba06, "CATHEDRAL\n");
			}
			else
			{
				// Instruction address 0x0000:0x09c8, size: 5
				this.oParent.CAPI.strcat(0xba06, "lower taxes.\n");
			}
		...
		L09c3:
			...
			this.oCPU.AX.UInt16 = 0x1;
			this.oCPU.CX.LowUInt8 = (byte)this.oParent.GameData.Cities[cityID].PlayerID;
			this.oCPU.AX.UInt16 = this.oCPU.SHL_UInt16(this.oCPU.AX.UInt16, this.oCPU.CX.LowUInt8);
			this.oCPU.TEST_UInt16(this.oCPU.AX.UInt16, (ushort)this.oParent.GameData.PlayerFlags);
			...
			this.oParent.PlayerTurn.F0_1403_3ed7(this.oParent.GameData.Cities[cityID].Position.X, this.oParent.GameData.Cities[cityID].Position.Y);
		...
		L0a48:
			if (this.oParent.GameData.Players[this.oParent.GameData.Cities[cityID].PlayerID].CityCount > 3)
				goto L0a5b;
			goto L0bc6;
		...
		L0af7:
			...
			this.oCPU.BX.UInt16 = this.oCPU.AX.UInt16;
			if (this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].PlayerID !=
				this.oParent.GameData.Cities[cityID].PlayerID) goto L0b14;
			goto L0bc6;
		...
		L0b92:
			this.oParent.Overlay_22.F22_0000_0af5(cityID, 
				this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe))].PlayerID);
		...
		L0c4c:
			...
			this.oParent.MapManagement.F0_2aea_0008_DrawVisibleMap(oParent.GameData.HumanPlayerID,
				this.oParent.GameData.Cities[cityID].Position.X - 10,
				this.oParent.GameData.Cities[cityID].Position.Y - 6);
		...
		/// <returns></returns>
		public ushort F20_0000_0ca9_ShowCivilizationScorePopup(short playerID, bool flag)
		{
			this.oCPU.Log.EnterBlock($"F20_0000_0ca9_ShowCivilizationScorePopup({playerID}, {flag})");
		...
		L0cc3:
			...
			this.oParent.Overlay_14.DrawLocalizedReportFrame(
				ClassicGameText.Current[
					ClassicGameTextKey.CivilizationScoreTitle],
				3);

		L0cd9:
			this.oParent.GameData.Players[0].Score = 0;
			...
			this.oParent.DrawTools.F0_1182_00b3_DrawCenteredStringToScreen0(
				ClassicGameText.Current[ClassicGameTextKey.ScoreCompleted],
				160,
				100,
				15);
		...
		L0d3e:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 0x1a);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc), 0x1a);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x3e7);
			this.oCPU.AX.UInt16 = 0;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x6), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x4), this.oCPU.AX.UInt16);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb25c, 0x3e7);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb2bc, 0x1a);
			...
			this.oParent.GameData.Players[playerID].TaxRate = (short)(6 - this.oParent.GameData.Players[playerID].ScienceTaxRate);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 0x0);
			goto L0e3c;

		L0d85:
			F20_0000_13f8((ushort)(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)) & 1));
		...
		L0da5:
			F20_0000_13f8((ushort)((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)) & 1) + 2));
		...
		L0db8:
			...
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e2));
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e4));
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_e8b8));
		...
		L0ddd:
			F20_0000_13f8((ushort)((this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)) & 1) + 4));
		...
		L0e00:
			...
			this.oCPU.AX.Int16 = (short)this.oParent.CityWorker.F0_1d12_6da1_GetSpecialWorkerFlags(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)));

			F20_0000_13f8((ushort)(this.oCPU.AX.UInt16 + 5));
			
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14))));

		L0e19:
			this.oCPU.AX.UInt16 = (ushort)((short)this.oParent.Var_e8b8);
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)), this.oCPU.AX.UInt16);
		...
		L0e21:
			...
			this.oCPU.AX.LowUInt8 = (byte)this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].ActualSize;
			this.oCPU.CBW(this.oCPU.AX);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e2));
			this.oCPU.AX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.AX.UInt16, (ushort)((short)this.oParent.Var_70e4));
		...
		L0e3c:
			...
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)));
			this.oCPU.SI.UInt16 = this.oCPU.AX.UInt16;
			this.oCPU.CMP_UInt8(this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].StatusFlag, 0xff);
			if (this.oCPU.Flags.E) goto L0e39;
			
			if (this.oParent.GameData.Cities[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))].PlayerID != playerID)
				goto L0e39;

			// Instruction address 0x0000:0x0e63, size: 5
			this.oParent.CityWorker.F0_1d12_0045_ProcessCityState(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), -1);
		...
		L0e79:
			...
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd766, this.oCPU.AX.UInt16);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScoreCitizensConnector]);

			// Instruction address 0x0000:0x0ec4, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd766), 10));
		...
		L0ef9:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x10);
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x3e7);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd764, 0x0);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 0x1);

		L0f15:
			this.oCPU.SI.UInt16 = (ushort)this.oParent.GameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))];
		...
		L0f2f:
			...
			if (this.oParent.GameData.Cities[this.oCPU.SI.UInt16].PlayerID != playerID) goto L0fb9;

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x98));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 0x12c);
			...
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(
				this.oCPU.ReadInt16(this.oCPU.DS.UInt16, 0x5116) + 2, 8, 99);

			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), this.oCPU.AX.UInt16));
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe), 0x10);

		L0f6a:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10));
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x18);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14), this.oCPU.AX.UInt16);

			if (!flag) goto L0fb4;

			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xb4);
			if (this.oCPU.Flags.GE) goto L0fb4;

			// Instruction address 0x0000:0x0f8c, size: 5
			this.oParent.CityWorker.F0_1d12_7045(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x14)),
				this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)),
				(short)(this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)) - 2));
			...
			this.oParent.DrawTools.F0_1182_005c_DrawStringToScreen0(
				ClassicDisplayNames.Wonder(
					...
					this.oParent.GameData.Wonders[
						this.oCPU.ReadInt16(
							this.oCPU.SS.UInt16,
							(ushort)(this.oCPU.BP.UInt16 - 0x10))].Name),
		...
		L0fb4:
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xd764, this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764), 0x14));

		L0fb9:
			if (this.oParent.GameData.WonderCityID[this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))] != -1)
				goto L0fca;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x8), 0x0);
		...
		L0fca:
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10), 
				this.oCPU.INC_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10))));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x10)), 0x15);
		...
		L0fd6:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScoreAchievementsConnector]);

			// Instruction address 0x0000:0x1014, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764), 10));
			...
			this.oParent.DrawTools.F0_1182_0086_DrawStringWithShadow(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xc)), 15);

		L1049:
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd764);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xd766));
			this.oParent.GameData.Players[0].Score = (short)this.oCPU.AX.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xa));
			this.oCPU.SI.UInt16 = (ushort)this.oParent.GameData.Players[oParent.GameData.HumanPlayerID].SpaceshipPopulation;
			this.oCPU.SI.UInt16 = this.oCPU.OR_UInt16(this.oCPU.SI.UInt16, this.oCPU.SI.UInt16);
			if (this.oCPU.Flags.NE) goto L1068;
			goto L1118;

		L1068:
			if (this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].SpaceshipSuccessRate != 0) goto L1072;
			goto L1118;

		L1072:
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].SpaceshipSuccessRate;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, this.oCPU.SI.UInt16);
			this.oCPU.CWD(this.oCPU.AX, this.oCPU.DX);
		...
		L1088:
			...
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScoreSpaceshipPrefix]);

			// Instruction address 0x0000:0x10b0, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0xe)), 10));
			
			if (this.oParent.GameData.Players[oParent.GameData.HumanPlayerID].SpaceshipETAYear != oParent.GameData.Year) goto L10d0;
		...
		L10d0:
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScorePossibleSuffix]);
		...
		L10e0:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xb8);
			if (this.oCPU.Flags.GE) goto L1114;

			// Instruction address 0x0000:0x110c, size: 5
			this.oParent.DrawTools.F0_1182_0086_DrawStringWithShadow(0xba06, 16, this.oCPU.ReadInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 15);
		...
		L1118:
			this.oCPU.WriteUInt8(this.oCPU.DS.UInt16, 0xba06, 0x0);
			if (this.oParent.GameData.PollutedSquareCount == 0) goto L1174;

			// Instruction address 0x0000:0x112c, size: 5
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScorePollutionPrefix]);

			// Instruction address 0x0000:0x1151, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)(-10 * this.oParent.GameData.PollutedSquareCount), 10));
		...
		L1174:
			...
			if (this.oParent.GameData.PeaceTurnCount == 0) goto L11e3;

			// Instruction address 0x0000:0x1191, size: 5
			this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(this.oParent.GameData.PeaceTurnCount * 3, 0, 100);
			...
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[ClassicGameTextKey.ScorePeacePrefix]);

			// Instruction address 0x0000:0x11c4, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x16)), 10));
		...
		L11e3:
			if (this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].FutureTechnologyCount == 0) goto L123a;

			// Instruction address 0x0000:0x11f2, size: 5
			this.oParent.CAPI.strcat(
				0xba06,
				ClassicGameText.Current[
					ClassicGameTextKey.ScoreFutureTechnologyPrefix]);

			// Instruction address 0x0000:0x1217, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)(5 * this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].FutureTechnologyCount), 10));

			// Instruction address 0x0000:0x1227, size: 5
			this.oParent.CAPI.strcat(0xba06, ")");

			this.oCPU.AX.UInt16 = 0x5;
			this.oCPU.IMUL_UInt16(this.oCPU.AX, this.oCPU.DX, (ushort)this.oParent.GameData.Players[this.oParent.GameData.HumanPlayerID].FutureTechnologyCount);
			this.oParent.GameData.Players[0].Score += (short)this.oCPU.AX.UInt16;
		...
		L123a:
			...
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12), 
				this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xa));
		...
		L1269:
			...
			this.oCPU.CX.UInt16 = this.oCPU.SUB_UInt16(this.oCPU.CX.UInt16, (ushort)this.oParent.GameData.TurnCount);
			...
			this.oCPU.CX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.CX.UInt16, 0x190);
			this.oCPU.WriteUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18), this.oCPU.CX.UInt16);
		...
		L128e:
			...
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.Players[0].Score;
			...
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[ClassicGameTextKey.ScoreTotalPrefix]);

			// Instruction address 0x0000:0x12cc, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa(this.oParent.GameData.Players[0].Score, 10));
			goto L130c;
		...
		L12d6:
			...
			this.oParent.CAPI.strcpy(
				0xba06,
				ClassicGameText.Current[ClassicGameTextKey.ScoreBonusPrefix]);

			// Instruction address 0x0000:0x12fe, size: 5
			this.oParent.CAPI.strcat(0xba06,
				this.oParent.CAPI.itoa((short)this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x18)), 10));
		...
		L130c:
			...
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.SS.UInt16, (ushort)(this.oCPU.BP.UInt16 - 0x12)), 0xba);
		...
		L1348:
			this.oCPU.AX.UInt16 = (ushort)this.oParent.GameData.Players[0].Score;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb77e, this.oCPU.AX.UInt16);

			if (!flag)
				goto L13f0;

			// Instruction address 0x0000:0x136f, size: 5
			this.oParent.DrawTools.FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 35, 192, 250, 7, 8);

			if (this.oParent.GameData.Players[0].Score > 0)
			{
				// Instruction address 0x0000:0x139f, size: 5
				this.oCPU.AX.Int16 = (short)this.oParent.Tools.F0_2dc4_007c_CheckValueRange(this.oParent.GameData.Players[0].Score / 4, 0, 250);

				// Instruction address 0x0000:0x13b4, size: 5
				this.oParent.DrawTools.FillRectangle(this.oParent.Var_aa_Screen0_Rectangle, 35, 192, (short)this.oCPU.AX.UInt16, 7, 11);
			}
		...
		L13f3:
			...
			// Far return
			this.oCPU.Log.ExitBlock("F20_0000_0ca9_ShowCivilizationScorePopup");
		...
		public void F20_0000_13f8(ushort param1)
		{
			...
			this.oCPU.PUSH_UInt16(this.oCPU.BP.UInt16);
			this.oCPU.BP.UInt16 = this.oCPU.SP.UInt16;
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb25c, this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb25c), 0x8));
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb25c), 0x124);
			if (this.oCPU.Flags.LE) goto L141d;
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0x5116);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb2bc, this.oCPU.ADD_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc), this.oCPU.AX.UInt16));
			this.oCPU.AX.UInt16 = this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc);
			this.oCPU.AX.UInt16 = this.oCPU.SAR_UInt16(this.oCPU.AX.UInt16, 0x1);
			this.oCPU.AX.UInt16 = this.oCPU.AND_UInt16(this.oCPU.AX.UInt16, 0x4);
			this.oCPU.AX.UInt16 = this.oCPU.ADD_UInt16(this.oCPU.AX.UInt16, 0x10);
			this.oCPU.WriteUInt16(this.oCPU.DS.UInt16, 0xb25c, this.oCPU.AX.UInt16);

		L141d:
			this.oCPU.CMP_UInt16(this.oCPU.ReadUInt16(this.oCPU.DS.UInt16, 0xb2bc), 0xa0);
